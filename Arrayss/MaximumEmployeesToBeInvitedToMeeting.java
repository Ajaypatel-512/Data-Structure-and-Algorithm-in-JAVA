...
public class MaximumEmployeesToBeInvitedToMeeting {
    /**
    ...
    public static void main(String[] args) {
        MaximumEmployeesToBeInvitedToMeeting obj = new MaximumEmployeesToBeInvitedToMeeting();
        System.out.println(obj.maximumInvitations(new int[]{2, 2, 1, 2})); // 3
        System.out.println(obj.maximumInvitations(new int[]{1, 2, 0})); // 3
        System.out.println(obj.maximumInvitations(new int[]{3, 0, 1, 4, 1})); // 4
    }
